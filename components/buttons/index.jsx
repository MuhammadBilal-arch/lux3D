...
export const ColoredButton = memo(({
  ...
  return (
    <button
      ...
      className={`${background} min-w-32 text-center flex items-center justify-center max-w-min border ${borderColor} transition duration-300 delay-300 hover:text-black hover:bg-white hover:border-white whitespace-nowrap items-center py-1 sm:py-2 px-4 md:px-5 xl:px-8 ${textColor} rounded-3xl text-xs md:text-xs lg:text-base`}
    >
      {title}
